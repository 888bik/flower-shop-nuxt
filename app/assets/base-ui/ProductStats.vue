  ...
  <div class="card">
    ...
    <div class="stats-wrapper">
      ...
      <div class="bottom-wrapper">
        ...
        <p class="count">{{ formattedReview }}</p>
      </div>
    </div>
    <div class="stats-wrapper">
      ...
      <div class="bottom-wrapper">
        ...
        <p class="count">{{ formattedSellCount }}</p>
      </div>
    </div>
  </div>
</template>
...
const { sales, rating, review } = defineProps<IProps>();
...
const formattedReview = computed(() => formatCount(review));
const formattedSellCount = computed(() => formatCount(sales));
</script>
...
.stats-wrapper {
  ...
  padding: 15px;
  box-shadow: 20px 20px 60px #e6e6e6, -20px -20px 60px #f3f3f3;
}
.heading {
  font-size: 0.9em;
  font-weight: 700;
