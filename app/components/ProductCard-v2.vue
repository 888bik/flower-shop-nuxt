<template>
  <div class="card">
    ...
    <div class="card__content">
      <div class="card__badge" :class="badgeClass">{{ badge }}</div>
      ...
      <div class="card__footer">
        ...
        <div class="card__button" @click.stop="$emit('add')">
...
.card__glow {
  ...
  background: radial-gradient(
    circle at 50% 0%,
    rgba(255, 111, 163, 0.3) 0%,
    rgba(255, 111, 163, 0) 70% /* rgba(124, 58, 237, 0.3) 0%, */
...
.card__image::after {
  ...
  background: radial-gradient(
    ...
    repeating-linear-gradient(
      45deg,
      rgba(255, 111, 163, 0.1) 0px,
      rgba(255, 111, 163, 0.1) 2px,
      transparent 2px,
      transparent 4px
    );
  opacity: 0.5;
...
.card:hover .card__button {
  ...
  box-shadow: 0 0 0 4px rgba(255, 111, 163/ 0.2);
}
